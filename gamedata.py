...
class FileParser:
    ...
    def cards_as_html(self) -> Generator[str, None, None]:
        text = (
            ...
            '</svg><span>{count}{card_name}</span></div>'
        )
        content = {}
...
class Victory(NodeData):
    ...
    [("Ascender's Bane", {'NAME': "Ascender's Bane", 'DESCRIPTION': 'Unplayable. Ethereal. Cannot be removed from your deck.', 'CHARACTER': 'Curse'}),
     ('Defend', {'NAME': 'Defend', 'DESCRIPTION': 'Gain !B! Block.', 'CHARACTER': 'Defect', 'RARITY': 'Starter', 'TYPE': 'Skill'}),
     ('Defend', {'NAME': 'Defend', 'DESCRIPTION': 'Gain !B! Block.', 'CHARACTER': 'Defect', 'RARITY': 'Starter', 'TYPE': 'Skill'}),
     ('Compile Driver', {'NAME': 'Compile Driver', 'DESCRIPTION': 'Deal !D! damage. NL Draw !M! card for each unique Orb you have.', 'CHARACTER': 'Defect', 'RARITY': 'Common', 'TYPE': 'Attack'}), ('Ball Lightning', {'NAME': 'Ball Lightning', 'DESCRIPTION': 'Deal !D! damage. Channel !M! Lightning.', 'CHARACTER': 'Defect', 'RARITY': 'Common', 'TYPE': 'Attack'}), ('Storm', {'NAME': 'Storm', 'DESCRIPTION': 'Whenever you play a Power card, Channel 1 Lightning.', 'UPGRADE_DESCRIPTION': 'Innate. NL Whenever you play a Power card, Channel 1 Lightning.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Power'}), ('Aggregate+', {'NAME': 'Aggregate', 'DESCRIPTION': 'Gain 1 Energy for every {} cards in your draw pile.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Skill', 'ENERGY_BASE': 1, 'VALUE_BASE': [3], 'VALUE_UPGRADE': [4]}), ('Tempest', {'NAME': 'Tempest', 'DESCRIPTION': 'Channel X Lightning. NL Exhaust.', 'UPGRADE_DESCRIPTION': 'Channel X+1 Lightning. NL Exhaust.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Skill'}), ('Self Repair', {'NAME': 'Self Repair', 'DESCRIPTION': 'At the end of combat, heal !M! HP.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Power'}), ('Machine Learning', {'NAME': 'Machine Learning', 'DESCRIPTION': 'At the start of your turn, draw !M! additional card.', 'UPGRADE_DESCRIPTION': 'Innate. NL At the start of your turn, draw !M! additional card.', 'CHARACTER': 'Defect', 'RARITY': 'Rare', 'TYPE': 'Power'}), ('Double Energy+', {'NAME': 'Double Energy', 'DESCRIPTION': 'Double your Energy. NL Exhaust.', 'UPGRADE_DESCRIPTION': 'Double your Energy.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Skill'}), ('Steam Barrier', {'NAME': 'Steam Barrier', 'DESCRIPTION': "Gain !B! Block. Decrease this card's Block by 1 this combat.", 'CHARACTER': 'Defect', 'RARITY': 'Common', 'TYPE': 'Skill'}), ('Electrodynamics', {'NAME': 'Electrodynamics', 'DESCRIPTION': 'Lightning now hits ALL enemies. NL Channel !M! Lightning.', 'CHARACTER': 'Defect', 'RARITY': 'Rare', 'TYPE': 'Power'}), ('Defragment+', {'NAME': 'Defragment', 'DESCRIPTION': 'Gain !M! Focus.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Power'}), ('Force Field', {'NAME': 'Force Field', 'DESCRIPTION': 'Costs 1 less [B] for each Power card played this combat. NL Gain !B! Block.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Skill'}), ('Panic Button', {'NAME': 'Panic Button', 'DESCRIPTION': 'Gain !B! Block. You cannot gain Block from cards for !M! turns. NL Exhaust.', 'CHARACTER': 'Colorless', 'RARITY': 'Uncommon', 'TYPE': 'Skill'}), ('Ball Lightning', {'NAME': 'Ball Lightning', 'DESCRIPTION': 'Deal !D! damage. Channel !M! Lightning.', 'CHARACTER': 'Defect', 'RARITY': 'Common', 'TYPE': 'Attack'}), ('Recycle+', {'NAME': 'Recycle', 'DESCRIPTION': 'Exhaust a card. Gain Energy equal to its cost.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Skill'}), ('Skim+', {'NAME': 'Skim', 'DESCRIPTION': 'Draw !M! cards.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Skill'}), ('Coolheaded+', {'NAME': 'Coolheaded', 'DESCRIPTION': 'Channel 1 Frost. NL Draw !M! card{plural1}.', 'CHARACTER': 'Defect', 'RARITY': 'Common', 'TYPE': 'Skill'}), ('Chill', {'NAME': 'Chill', 'DESCRIPTION': 'Channel !M! Frost for each enemy in combat. NL Exhaust.', 'UPGRADE_DESCRIPTION': 'Innate. NL Channel !M! Frost for each enemy in combat. NL Exhaust.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Skill'}), ('Glacier', {'NAME': 'Glacier', 'DESCRIPTION': 'Gain !B! Block. NL Channel !M! Frost.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Skill'}), ('Echo Form', {'NAME': 'Echo Form', 'DESCRIPTION': 'Ethereal. The first card you play each turn is played twice.', 'DESCRIPTION_UPGRADE': 'The first card you play each turn is played twice.', 'CHARACTER': 'Defect', 'RARITY': 'Rare', 'TYPE': 'Power'}), ('Tempest', {'NAME': 'Tempest', 'DESCRIPTION': 'Channel X Lightning. NL Exhaust.', 'UPGRADE_DESCRIPTION': 'Channel X+1 Lightning. NL Exhaust.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Skill'}), ('Go for the Eyes+', {'NAME': 'Go for the Eyes', 'DESCRIPTION': 'Deal !D! damage. NL If the enemy intends to attack, apply !M! Weak.', 'CHARACTER': 'Defect', 'RARITY': 'Common', 'TYPE': 'Attack'}), ('Cold Snap', {'NAME': 'Cold Snap', 'DESCRIPTION': 'Deal !D! damage. Channel !M! Frost.', 'CHARACTER': 'Defect', 'RARITY': 'Common', 'TYPE': 'Attack'}), ('Static Discharge', {'NAME': 'Static Discharge', 'DESCRIPTION': 'Whenever you receive unblocked attack damage, Channel !M! Lightning.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Power'}), ('Reinforced Body', {'NAME': 'Reinforced Body', 'DESCRIPTION': 'Gain !B! Block X times.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Skill'}), ('Loop+', {'NAME': 'Loop', 'DESCRIPTION': 'At the start of your turn, trigger the passive ability of your next Orb.', 'UPGRADE_DESCRIPTION': 'At the start of your turn, trigger the passive ability of your next Orb !M! times.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Power'}), ('Hologram+', {'NAME': 'Hologram', 'DESCRIPTION': 'Gain !B! Block. NL Put a card from your discard pile into your hand. NL Exhaust.', 'UPGRADE_DESCRIPTION': 'Gain !B! Block. NL Put a card from your discard pile into your hand.', 'CHARACTER': 'Defect', 'RARITY': 'Common', 'TYPE': 'Skill'}), ('Glacier', {'NAME': 'Glacier', 'DESCRIPTION': 'Gain !B! Block. NL Channel !M! Frost.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Skill'}), ('Coolheaded+', {'NAME': 'Coolheaded', 'DESCRIPTION': 'Channel 1 Frost. NL Draw !M! card{plural1}.', 'CHARACTER': 'Defect', 'RARITY': 'Common', 'TYPE': 'Skill'}), ('Stack+', {'NAME': 'Stack', 'DESCRIPTION': 'Gain Block equal to the number of cards in your discard pile.', 'DESCRIPTION_UPGRADE': 'Gain Block equal to the number of cards in your discard pile +3.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Skill'}), ('Capacitor+', {'NAME': 'Capacitor', 'DESCRIPTION': 'Gain !M! Orb slots.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Power'}), ('Tempest+', {'NAME': 'Tempest', 'DESCRIPTION': 'Channel X Lightning. NL Exhaust.', 'UPGRADE_DESCRIPTION': 'Channel X+1 Lightning. NL Exhaust.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Skill'}), ('Overclock+', {'NAME': 'Overclock', 'DESCRIPTION': 'Draw !M! cards. NL Add a *Burn into your discard pile.', 'CHARACTER': 'Defect', 'RARITY': 'Uncommon', 'TYPE': 'Skill'})]
